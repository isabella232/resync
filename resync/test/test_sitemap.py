...
class TestSitemap(unittest.TestCase):
    ...
    def test_02_resource_str(self):
        ...
        self.assertEqual(Sitemap().resource_as_xml(
            r1), "<?xml version='1.0' encoding='UTF-8'?>\n<url><loc>3b</loc><lastmod>1970-01-01T00:20:34.099999Z</lastmod><rs:md hash=\"md5:ab54de\" length=\"9999\" /></url>")
    ...
    def test_03_resource_str_hashes(self):
        ...
        r1.sha1 = 'bbb'
        self.assertEqual(Sitemap().resource_as_xml(
            r1), "<?xml version='1.0' encoding='UTF-8'?>\n<url><loc>03hashes</loc><lastmod>1970-01-01T00:20:34.099999Z</lastmod><rs:md hash=\"md5:aaa sha-1:bbb\" /></url>")
        r1.sha256 = 'ccc'
        self.assertEqual(Sitemap().resource_as_xml(
            r1), "<?xml version='1.0' encoding='UTF-8'?>\n<url><loc>03hashes</loc><lastmod>1970-01-01T00:20:34.099999Z</lastmod><rs:md hash=\"md5:aaa sha-1:bbb sha-256:ccc\" /></url>")
        r1.sha1 = None
        self.assertEqual(Sitemap().resource_as_xml(
            r1), "<?xml version='1.0' encoding='UTF-8'?>\n<url><loc>03hashes</loc><lastmod>1970-01-01T00:20:34.099999Z</lastmod><rs:md hash=\"md5:aaa sha-256:ccc\" /></url>")
...
<url><loc>/tmp/rs_test/src/file_b</loc><lastmod>2012-03-14T18:37:36Z</lastmod><rs:md length=\"32\" /></url>\
        ...
        s = Sitemap()
        s.parse_xml(fh=io.StringIO(xml))
        self.assertFalse(s.parsed_index, 'was a sitemap')
