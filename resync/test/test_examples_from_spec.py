...
class TestExamplesFromSpec(unittest.TestCase):
    ...
    def test_ex_01(self):
        ...
        rl=ResourceList()
        rl.parse(uri='testdata/examples_from_spec/resourcesync_ex_1.xml')
    ...
    def test_ex_02(self):
        ...
        rl=ResourceList()
        rl.parse(uri='testdata/examples_from_spec/resourcesync_ex_2.xml')
        self.assertEqual( len(rl.resources), 2, '2 resources')
        sms = sorted(rl.uris())
        self.assertEqual( sms, ['http://example.com/res1','http://example.com/res2'] )
    ...
    def test_ex_03(self):
        ...
        cl=ChangeList()
        cl.parse('testdata/examples_from_spec/resourcesync_ex_3.xml')
    ...
    def test_ex_04(self):
        ...
        rd=ResourceDump()
        rd.parse('testdata/examples_from_spec/resourcesync_ex_4.xml')
    ...
    def test_ex_05(self):
        ...
        rdm.parse('testdata/examples_from_spec/resourcesync_ex_5.xml')
    ...
    def test_ex_06(self):
        ...
        capl=CapabilityList()
        capl.parse('testdata/examples_from_spec/resourcesync_ex_6.xml')
    ...
    def text_ex_07(self):
        ...
        sd.read(uri='testdata/examples_from_spec/resourcesync_ex_7.xml')
    ...
    def test_ex_08(self):
        ...
        rl=ResourceList()
        rl.read(uri='testdata/examples_from_spec/resourcesync_ex_8.xml',index_only=True)
        self.assertEqual( rl.capability, 'resourcelist' )
    ...
    def test_ex_12(self):
        ...
        sd=SourceDescription()
        sd.read(uri='testdata/examples_from_spec/resourcesync_ex_12.xml')
...
##### UTILITIES FOR (APPROX) COMPARISON OF XML IN EXAMPLES AND OUTPUT
    ...
    def _open_ex(self,ex):
        return open('testdata/examples_from_spec/%s.xml'%(ex),'r')
